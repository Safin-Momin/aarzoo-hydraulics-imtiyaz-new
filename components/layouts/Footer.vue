...
<template>
  <footer class="text-primary-900 border-t border-gray-200 px-4 sm:px-6">
    ...
    >
      ...
      <div class="flex flex-col gap-2 sm:gap-6">
        ...
        <p class="text-sm leading-relaxed">
          ...
          hydraulic pumps, motors & its spares with a strong commitment to fast,
          efficient, and reliable service. The company today stands as the largest
        ...
        <div class="flex justify-center md:justify-start space-x-4 sm:space-x-6 mt-1 sm:mt-0">
          ...
          <NuxtLink
            to="https://www.instagram.com/aarzoo_hydraulic_?igsh=b3M1ZGMwaDB1MW5o"
            class="text-primary-400 hover:text-primary-600"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <NuxtLink
            to="https://x.com/AarzooHydraulic"
            class="text-primary-400 hover:text-primary-600"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <ul class="space-y-2 sm:space-y-6 text-sm">
          ...
          <li>
            <NuxtLink
              ...
              >Enquiry Now</NuxtLink
            >
          </li>
          <li>
            <NuxtLink to="/companies">Partners Info</NuxtLink>
          </li>
        </ul>
      </div>
    ...
    <div class="border-t border-gray-200 py-4 sm:py-6 text-center">
      <p>All Rights Reserved By Aarzoo Hydraulic</p>
    </div>
  </footer>
</template>
