...
const perks = [
  {
    ...
    imageUrl: '../images/icon-calendar-light.svg',
    description:
      'We offer a delivery service that has never been done before. Checkout today and receive your products as soon as possible.',
  },
  {
